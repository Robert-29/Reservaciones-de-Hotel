const Ofertas = () => { 
    return(
        <section className="bg-gray-50 w-full p-8 md:p-20 mt-10 md:mt-20">
            <h1 className="text-3xl md:text-4xl text-center font-cormorant font-light tracking-wider">Ofertas Especiales</h1>
            <div className="w-full flex justify-center flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-10 mt-10 items-center">
                ...
                className="w-full sm:w-[80%] md:w-[30%] p-8 bg-white rounded-xl flex flex-col justify-center items-center space-y-3 hover:shadow-md transition duration-500" >
                    ...
                    <h3 className="font-cormorant font-light tracking-wider text-xl text-gray-800 text-center" >Escapada Romántica</h3>
                    ...
                    <span className="text-xl md:text-xl font-inter text-green-700" >Desde $399/noche</span>
                </div>
                <div
                    data-aos="fade-up" //inicia la animación, entra de abajo hacia arriba
                ...
                className="w-full sm:w-[80%] md:w-[30%] p-8 bg-white rounded-xl flex flex-col justify-center items-center space-y-3 hover:shadow-md transition duration-500" >
                    ...
                    <h3 className="font-cormorant font-light tracking-wider text-xl text-gray-800 text-center" >Paquete Familiar</h3>
                    ...
                    <span className="text-xl md:text-xl font-inter text-green-700" >Desde $499/noche</span>
                </div>
                <div
                    data-aos="fade-up" //inicia la animación, entra de abajo hacia arriba
                ...
                className="w-full sm:w-[80%] md:w-[30%] p-8 bg-white rounded-xl flex flex-col justify-center items-center space-y-3 hover:shadow-md transition duration-500" >
                    ...
                    <h3 className="font-cormorant font-light tracking-wider text-xl text-gray-800 text-center" >Estancia Prolongada</h3>
                    <p className="font-inter text-gray-600 text-center" >Descuentos especiales para reservas de 5 noches o más</p>
                    <span className="text-xl md:text-xl font-inter text-green-700" >15% de descuento</span>
                </div>
            </div>
        </section>
    )
